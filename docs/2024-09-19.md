...
last_modified_at: "2024-09-20 03:00:39 +0900"
---
...
```
これらは再利用を容易にするためにレイアウトと投稿で混在させることができるパーシャルです。 liquidタグ{% include file.ext %}はパーシャルを_includes/file.extにインクルードするために使われます。
```
