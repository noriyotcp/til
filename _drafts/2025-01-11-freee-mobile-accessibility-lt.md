...
📱 様々なアクセシビリティ改善事例: コントラスト比の改善、ボイスオーバー対応、UXライティング、フラッターアプリでの対応など、具体的な改善事例が多数紹介された。
...
A: コントラスト比の改善、ボイスオーバー対応における読み上げ情報の工夫（正眼者が得られる情報以上の情報は読み上げない）、アクションの活用による操作性の向上、カスタムコンポーネント作成におけるアクセシビリティ対応、既存アプリの問題点発見のためのGoogle Playコンソールレポート活用などが挙げられました。
